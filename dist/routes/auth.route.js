...
authRouter.post("/admin-login", RequestValidation_1.RequestValidation.validateFunction(requestValidationConfig_1.requestValidationConfig.employerLogin), auth_controller_1.AdminLogin);
// authRouter.post(
//   "/employee/create",
