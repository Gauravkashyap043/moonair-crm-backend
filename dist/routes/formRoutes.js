...
formRouter.get("/complain-data/:complainId", formControllers_1.GetSingleComplainData);
formRouter.get("/complain-data-register/:id", formControllers_1.GetComplainFromDataByRegister);
formRouter.get("/complain-data-assignedTo/:id", formControllers_1.GetComplainFromDataByAssignedTo);
